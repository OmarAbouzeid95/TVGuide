        ...
        <div>
          ...
          <ul>
            <li className="footer-link">
              <Link to={`/popular/${mode}`}>Popular</Link>
            </li>
            <li className="footer-link">
              <Link to={`/top-rated/${mode}`}>Top Rated</Link>
            </li>
            <li className="footer-link">
            ...
            <li className="footer-link">
              <Link to={userData ? "/profile/account-details" : "/signin"}>
          ...
          <ul className="social-links">
            <li>
              <Link
                ...
                to={`https://www.instagram.com/omaradharn/`}
                target="_blank">
            ...
            <li>
              <Link
                className="footer-link"
                to={`https://www.linkedin.com/in/omarabouzeidali/`}
                target="_blank">
            ...
            <li>
              <Link
                className="footer-link"
                to={`https://github.com/OmarAbouzeid95`}
                target="_blank">
